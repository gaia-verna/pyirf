"""
Example for using pyirf to calculate IRFS and sensitivity from protopipe DL2 HDF5
files produced from the protopipe pipeline:
...
from pyirf.io.protopipe import read_protopipe_hdf5
